TestRailsOnDigitalOcean::Application.routes.draw do
  ...
  resources :users do
    ...
    resources :collected_recipes, only: [:show, :destroy]
  ...
  post '/users/:user_id/collected_recipes/:recipe_id/destroy', to: 'collected_recipes#destroy'

  post '/create-collected-recipe', to: 'collected_recipes#create'
